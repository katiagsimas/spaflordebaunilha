...
export function TipoEmbalagemAutocomplete({ onSelect, value, onAfterCreate }: TipoEmbalagemAutocompleteProps) {
  ...
  const { tiposEmbalagens, createTipoEmbalagem } = useTiposEmbalagens();
  ...
  const filteredTipos = tiposEmbalagens.filter((tipo) =>
  ...
  const handleSubmitNew = (e: React.FormEvent) => {
    ...
    createTipoEmbalagem.mutate(data, {
      onSuccess: (newTipo) => {
        onSelect(newTipo as TipoEmbalagem);
  ...
  const selectedTipo = tiposEmbalagens.find((tipo) => tipo.id === value);
