...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary hover:bg-primary-dark text-white font-medium shadow-sm hover:shadow-md",
        destructive: "bg-error hover:bg-red-600 text-white font-medium shadow-sm hover:shadow-md",
        outline: "border-2 border-primary text-primary hover:bg-primary hover:text-white font-medium",
        secondary: "bg-terracotta hover:bg-terracotta-dark text-white font-medium shadow-sm hover:shadow-md",
        ghost: "bg-transparent hover:bg-cream font-medium",
