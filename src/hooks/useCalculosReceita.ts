    ...
    queryFn: async () => {
      ...
      const resumos: ResumoReceita[] = receitas.map((receita) => {
        ...
        return {
          ...
          tempoPreparo: (receita as any).tempo_receita || (receita as any).tempo_preparo || 0,
          unidadeTempo: (receita as any).tempo_receita_unidade || (receita as any).tempo_preparo_unidade || "minutos",
          custoInsumos,
          custoEmbalagens,
          custoMaoObra,
          despesasVenda,
