        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-9 gap-1.5">
          {[
            ...
            <Card
              ...
              className={`cursor-pointer hover:shadow-md transition-all duration-200 hover:-translate-y-0.5 border-l-2 border-l-[#D89B8C] group ${filtroCard === item.key ? 'ring-2 ring-[#D8CBB9] bg-[#D8CBB9]/15' : ''}`}
            >
