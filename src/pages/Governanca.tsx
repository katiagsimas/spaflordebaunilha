        ...
        <div className="grid gap-4 sm:grid-cols-2 max-w-4xl">
          {cards.map(({ title, description, icon: Icon, url }) => (
            <Link key={url} to={url} className="group">
              <Card className="h-full transition-all duration-200 hover:shadow-lg border-sfb-areia hover:border-sfb-terracota/60 cursor-pointer">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="h-11 w-11 rounded-lg bg-sfb-baunilha flex items-center justify-center group-hover:bg-sfb-areia/20 transition-colors">
