  ...
  return (
    <div className="min-h-screen bg-background p-4 md:p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
        <Card
          className="group cursor-pointer hover:shadow-lg hover:scale-[1.02] transition-all duration-200 border-l-2 border-cda-dourado/60"
          onClick={() => navigate("/clientes")}
        >
          <CardHeader className="p-4 space-y-2">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-cda-creme text-cda-dourado flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
