          ...
          <CardContent className="py-3 px-4">
            <div className="flex items-end gap-3">
              <div className="flex flex-col gap-1 w-28">
                <Label htmlFor="ano" className="text-xs font-medium text-sfb-cacau/70">Ano</Label>
                <Input
                  id="ano"
                  type="number"
                  value={ano}
        ...
        <CardContent>
          <div className="overflow-x-auto">
            <Table>
              ...
              <TableBody>
                {/* SALDO INICIAL */}
                <TableRow className="bg-sfb-areia/10/50">
                  <TableCell className="font-bold sticky left-0 bg-sfb-areia/10/50 z-10">SALDO INICIAL</TableCell>
                  {fluxo.map((f, i) => (
