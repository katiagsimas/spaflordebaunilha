...
export default function BankReportsPage() {
  ...
  const { data: stats } = useQuery({
    ...
    queryFn: async () => {
      ...
      const reconciled = data.filter(e => e.status === "reconciled").length;
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      <PageHeader
        ...
        subtitle="Acompanhe pendências e qualidade dos matches"
      />
                ...
                <TableBody>
                  {differences.map((diff, idx) => (
                    <TableRow key={idx}>
                      ...
                      <TableCell>
                        <span className={diff.tipo === "sobra" ? "text-green-600" : "text-red-600"}>
                          {diff.tipo}
                        </span>
                      </TableCell>
                    </TableRow>
