...
const COR_DOURADO = "#C9A14A";
const COR_VINHO = "#5B1A2B";
const COR_VINHO_ESCURO = "#3D0F1C";

const DISTRIB_CORES = ["#3D0F1C", "#5B1A2B", "#8B4513", "#C9A14A", "#D2B48C"];
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-col items-center gap-2">
        <p className="text-[10px] uppercase tracking-widest text-[#3D0F1C]/50">Mês de referência</p>
        <div className="flex items-center gap-4">
          <button
            type="button"
            onClick={irAnterior}
            aria-label="Mês anterior"
            className="w-9 h-9 rounded-full border border-[#5B1A2B]/20 text-[#5B1A2B] flex items-center justify-center hover:bg-[#FDF6EE] transition"
          >
            <ChevronLeft className="h-4 w-4" />
          </button>
          <span
            className="text-base text-[#3D0F1C] capitalize text-center min-w-[160px]"
          ...
          <button
            ...
            className="w-9 h-9 rounded-full border border-[#5B1A2B]/20 text-[#5B1A2B] flex items-center justify-center hover:bg-[#FDF6EE] transition disabled:opacity-30 disabled:cursor-not-allowed"
          >
      ...
      {isLoading && (
        <div className="text-[#5B1A2B] py-10 text-center">Preparando seu resumo...</div>
      )}
      ...
      {resumo && !isLoading && !error && (
        <>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="bg-white border border-[#5B1A2B]/10 rounded-xl p-5 flex flex-col">
              <h3 className="text-[18px] text-[#3D0F1C] mb-4" style={{ fontFamily: PLAYFAIR }}>
                Receita e Custo
              </h3>

              <div className="grid grid-cols-2 gap-4 mb-3">
                <div>
                  <p className="text-xs text-[#3D0F1C]/55">Receita Total</p>
                  <p className="text-[22px] font-bold text-[#3D0F1C] leading-tight">
                    {formatBRL(resumo.faturamento)}
                  </p>
                </div>
                <div className="text-right">
                  <p className="text-xs text-[#3D0F1C]/55">Lucro Bruto</p>
                  <p className="text-base font-bold text-[#3D0F1C] leading-tight">
              ...
              <div className="flex justify-end mt-2">
                <div className="text-right">
                  <p className="text-xs text-[#3D0F1C]/55">Custo Total</p>
                  <p className="text-[22px] font-bold text-[#3D0F1C] leading-tight">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white border border-[#5B1A2B]/10 rounded-xl p-5">
                <h3 className="text-base text-[#3D0F1C] mb-3" style={{ fontFamily: PLAYFAIR }}>
                  Distribuição de Custos
                </h3>
                  ...
                  <ul className="space-y-1.5">
                    {dadosDistribuicao.map((d) => (
                      <li key={d.name} className="flex items-center justify-between gap-2 text-xs">
                        ...
                        <span className="text-[#3D0F1C]/50">{d.value}% Ilustrativo</span>
                      </li>
                    ))}
                  </ul>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-white border border-[#5B1A2B]/10 rounded-xl p-4">
                  <h3 className="text-[15px] text-[#3D0F1C] mb-3" style={{ fontFamily: PLAYFAIR }}>
                    Retiradas Disponíveis
                  </h3>
                  <p className="text-xs text-[#3D0F1C]/55">Disponível para Retirada</p>
                  <p className="text-[26px] font-bold text-[#3D0F1C] leading-tight mt-1">
                ...
                {/* Performance do Mês */}
                <div className="bg-white border border-[#5B1A2B]/10 rounded-xl p-4">
                  <h3 className="text-[15px] text-[#3D0F1C] mb-2" style={{ fontFamily: PLAYFAIR }}>
                    Performance do Mês
                  </h3>
          ...
          <div className="flex justify-end">
            <Button
              ...
              variant="outline"
              className="border-[#C9A14A] text-[#5B1A2B] hover:bg-[#FDF6EE]"
            >
