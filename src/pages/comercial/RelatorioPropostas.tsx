      ...
      <div className="p-6 max-w-5xl mx-auto space-y-6">
        <Card className="border-sfb-areia/40">
          <CardContent className="p-6 flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-sfb-cacau mt-1">{brl(totalAno)}</p>
            </div>
        ...
        <Card>
          <CardContent className="p-6">
            <h2 className="text-lg font-semibold text-sfb-cacau mb-4">Propostas por mês</h2>
        ...
        <Card>
          <CardContent className="p-6">
            <h2 className="text-lg font-semibold text-sfb-cacau mb-4">Distribuição por status</h2>
