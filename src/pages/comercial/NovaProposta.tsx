  ...
  return (
    <div className="flex-1">
      <PageHeader
        ...
        actions={
          <div className="flex gap-2">
            ...
            <Button className="bg-sfb-terracota hover:bg-sfb-terracota-escuro text-sfb-baunilha" onClick={handleSaveAndExit}>
      ...
      <div className="p-6 max-w-5xl mx-auto space-y-6">
        ...
        <Card>
          <CardContent className="p-6 space-y-4">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold text-sfb-cacau">Itens do orçamento</h2>
              ...
              {produtos.map((p) => (
                <div key={p.id} className="grid grid-cols-12 gap-2 items-end p-3 border rounded-md">
                  ...
                  <div className="col-span-3 md:col-span-2 text-right text-sm">
                    ...
                    <div className="h-10 flex items-center justify-end font-semibold text-sfb-cacau">{brl(p.quantidade * p.preco_unitario)}</div>
                  </div>
            ...
            <div className="border-t pt-4 grid md:grid-cols-3 gap-4">
              ...
              <div className="text-right">
                ...
                <p className="text-2xl font-bold text-sfb-cacau">{brl(valor_total)}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-6 space-y-4">
            <h2 className="text-lg font-semibold text-sfb-cacau">Condições e observações</h2>
