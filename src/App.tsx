    ...
    <AuthProvider>
      <TooltipProvider>
        ...
        <BrowserRouter>
          ...
          {/* Páginas independentes de Clientes e Fornecedores */}
          ...
          <Route path="/cadastros/clientes" element={<Navigate to="/clientes" replace />} />
          <Route path="/cadastros/fornecedores" element={<Navigate to="/fornecedores" replace />} />
