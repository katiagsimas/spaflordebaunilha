...
// Execute esta instrucao no projeto: Em Cadastros, crie o card "Produtos de Revenda", dentro deste card, crie os cards "Natura, Avon, Casa & Estilo (não insira nada dentro deste cards)
