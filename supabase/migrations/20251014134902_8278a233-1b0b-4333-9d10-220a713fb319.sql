...
-- ============================================
-- FASE 2: MIGRAÇÃO COMPLETA PARA NUVEM (CORRIGIDA)
-- Remove políticas duplicadas e recria tudo
-- ============================================
...
DECLARE
    pol record;
BEGIN
    -- Remover todas as políticas das tabelas que vamos criar/atualizar
    FOR pol IN 
        SELECT schemaname, tablename, policyname 
        FROM pg_policies 
        WHERE schemaname = 'public'
          AND tablename IN ('clientes', 'fornecedores', 'categorias', 'unidades_medida', 
                           'custos_fixos', 'embalagens', 'ingredientes', 'encomendas',
                           'categorias_financeiras', 'contas_receber', 'contas_pagar', 'bancos')
    LOOP
