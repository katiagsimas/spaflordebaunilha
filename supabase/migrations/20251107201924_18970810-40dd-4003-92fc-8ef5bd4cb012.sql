-- Função corrigida para deletar dados seletivamente (desabilitando triggers temporariamente)
...
BEGIN
  ...
  IF (p_selecao->>'planoContas')::BOOLEAN THEN
    ...
    ALTER TABLE plano_contas DISABLE TRIGGER proteger_contas_padrao;
    ALTER TABLE plano_contas DISABLE TRIGGER impedir_exclusao_padrao;
    ...
    -- Reabilitar trigger
    ALTER TABLE plano_contas ENABLE TRIGGER proteger_contas_padrao;
    ALTER TABLE plano_contas ENABLE TRIGGER impedir_exclusao_padrao;
  END IF;
  ...
  IF (p_selecao->>'categoriasPlanoContas')::BOOLEAN THEN
    ...
    ALTER TABLE plano_contas DISABLE TRIGGER proteger_contas_padrao;
    ALTER TABLE plano_contas DISABLE TRIGGER impedir_exclusao_padrao;
    ALTER TABLE categorias_plano_contas DISABLE TRIGGER proteger_categorias_padrao;
    
    -- Deletar plano_contas associado
    ...
    ALTER TABLE plano_contas ENABLE TRIGGER proteger_contas_padrao;
    ALTER TABLE plano_contas ENABLE TRIGGER impedir_exclusao_padrao;
    ALTER TABLE categorias_plano_contas ENABLE TRIGGER proteger_categorias_padrao;
  END IF;
