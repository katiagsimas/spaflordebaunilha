...
-- Adicionar categoria "Receitas com Serviços" (código 4) na função de criar categorias padrão
...
BEGIN
  ...
  (p_user_id, '111', 'Investimentos (+)', 'Credito', 'Investimento', 18, true)
  ON CONFLICT (user_id, codigo) DO NOTHING;
END;
$function$;

-- Adicionar contas padrão da categoria 4 na função de criar planos padrão
