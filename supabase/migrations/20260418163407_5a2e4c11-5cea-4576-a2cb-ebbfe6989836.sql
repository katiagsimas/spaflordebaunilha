...
DROP TRIGGER IF EXISTS on_auth_user_created_ingredientes ON auth.users;
CREATE TRIGGER on_auth_user_created_ingredientes
AFTER INSERT ON auth.users
FOR EACH ROW
EXECUTE FUNCTION public.trigger_criar_ingredientes_padrao();
