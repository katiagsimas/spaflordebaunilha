...
| 2026-05-26 | Limpeza — assets órfãos em `src/assets/` | Removidos `auth-background.png`, `donnas-box-logo.png`, `donnas-logo.png`, `doces-background.jpg`, `caixa-acucar-logo.png` e o duplicado `sfb-logo-dourado.png` (mantido apenas em `public/`). |
|------------|------|-----------|
